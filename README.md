...
Все запросы (кроме `/auth`) требуют заголовка `Authorization: Bearer <token>`. Ответы всегда в формате JSON. Постраничный вывод: `?page=1&limit=20`. Ошибки: `{ "detail": "...", "code": "..." }`.
